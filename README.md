...
<div align="center">
  ...
  <h3><b>Welcome to Microverse</b></h3>
...
# 📖 [Welcome to Microverse] <a name="about-project">About</a>

This project is basically a demonstration of applying linters on the webpage in order to make the code concise, correct and standardized. Later on the code is to be pushed on github.
...
- [Live Demo Link](https://github.com/ehmaddd/hello-microverse)

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## 💻 Getting Started <a name="getting-started"></a>

You can get help from the linter files and its way to check the errors and use the files as a blue print for checking multiple files.
...
_NOTE: we recommend using the [MIT license](https://github.com/ehmaddd/hello-microverse/blob/main/LICENSE)
